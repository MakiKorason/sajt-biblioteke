...
const Scientific = () => {
  return (
    <>
      ...
      <main className="scientific-page">
        ...
        <section className="scientific-hero">
          ...
          <div className="scientific-hero-background">

            <div className="scientific-hero-circle scientific-circle-one"></div>

            <div className="scientific-hero-circle scientific-circle-two"></div>
          ...
          <div className="scientific-hero-content">
            ...
            <h1>
              Научна и <em>стручна</em> литература
            </h1>

            <p>
              Простор знања, истраживања и учења, намењен свима
              који желе да откривају, истражују и проширују своја
              знања.
            </p>
          ...
          <div className="scientific-hero-book">
  ...
  <div className="contact-hero-book contact-book-right">
    <GiOpenBook />
        ...
        <Container className="container-library">
          ...
          <section className="scientific-intro">
          ...
          <section className="scientific-services">
          ...
          <section className="scientific-cultural">
            ...
            <div className="scientific-mission">
              ...
              <div className="scientific-mission-inner">
                ...
                <div className="scientific-mission-icon">
                  <LiaBookSolid />
                </div>
