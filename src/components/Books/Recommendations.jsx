      ...
      <div id="menu1" className="container tab-pane fade">
        ...
        <Row>
          ...
          <p className='container-text'>
              ...
              „Лето када сам научила да летим“ је нежан и емотиван роман о одрастању, првој љубави и једном лету који заувек мења живот. У средишту приче је тринаестогодишња Софија, која одлази на море и тамо, кроз нова познанства, дружење и прва осећања, полако улази у свет одраслих.
              <br/><br/>
              ...
              <br/><br/>
              Ипак, иза ове наизглед безбрижне летње приче налази се и много озбиљнија тема. Кроз породичне односе и сећања провлачи се прича о <strong>ратовима деведесетих и поделама које су политика и сукоби унели међу српске и хрватске породице</strong>. Роман показује како наслеђене предрасуде и сукоби одраслих могу да оптерете и животе младих.
              <br/><br/>
