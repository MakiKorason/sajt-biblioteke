                ...
                <div className="competition-documents">
                  ...
                  <div className="competition-document">
                    ...
                    <div>
                     ...
                     <Button
  onClick={() => window.open("/prijava.2014.pdf", "_blank")}
...
>
  ...
  Преузми пријаву
              ...
              Аутори своје рукописе достављају под шифром, која се уписује на сва три примерка рукописа. Уз рукопис се прилаже и једна мања, затворена коверта са папирићем на којем су наведени име и презиме аутора, односно разрешење шифре. Коверта треба да буде означена истом шифром као и рукопис.

                </strong><br/><br/>
<strong> Затим се та мала коверта ставља у велику коверту заједно са три примерака рукописа, попуњеном пријавом и електронском верзијом рукописа на CD-у или USB-у. Тако припремљену велику коверту залепити и послати Градској библиотеци на адресу: Главна 114, Рума.</strong> 
              </div>
